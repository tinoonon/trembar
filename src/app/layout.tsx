...
export const metadata: Metadata = {
  title: 'Trem Bar Gastronomia | Cozinha Artesanal Mineira',
  description: 'Chopes gelados, drinks autorais e a alma de Minas em cada prato no Mercadão de Lagoa Santa.',
};
